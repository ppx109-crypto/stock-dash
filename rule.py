...
CAVEAT = (
    ...
    "**+3.81%**(폭 2.5)·뒤쪽(2021~) **+18.63%**(폭 1.4)이고, 골은 "
    "**−14.4%와 −10.5%**, 연패는 5와 7입니다. "
    "**앞쪽 수치가 57회차에 반 토막 났습니다**(+7.37% → +3.81%). 값이 "
    "바뀐 것이 아니라, 그때까지 주식수 자료가 199종목에만 있어 하루에 "
    "153종목으로만 줄을 세우고 있었기 때문입니다. 499종목으로 제대로 "
    "세우니 '100등 안'이 훨씬 좁아졌고, 그만큼 성적이 내려갔습니다. "
    "쉰 회차 넘게 부풀어 있던 수치입니다. "
    "한 번만 돌린 "
    "수치는 여러 번 중 좋은 쪽일 수 있습니다 — 40회차에 그런 수치 하나에 "
    "속아 결론을 냈다가 거뒀습니다. 열 번에 다섯 번은 집니다. "
    "앞쪽 구간은 한 해 열다섯 번 남짓 매매해서 +3.81%입니다. 비용과 "
