...
CAVEAT = (
    "**이 수치는 임시입니다.** 조사 대상이 501종목이고 그날 순위를 매길 수 "
    ...
    "501종목에서 여덟 번 돌린 가운데값으로 골은 앞쪽(2015~2020) −13.0%, "
    "뒤쪽(2021~) −12.6%이고 연수익은 +3.82%와 +14.26%입니다. 한 번만 돌리면 "
    "+6.19%와 +14.77%가 나오는데 그것은 여러 번 중 좋은 쪽입니다 — 40회차에 "
    "그런 수치 하나에 속아 결론을 냈다가 거뒀습니다. 열 번에 다섯 번은 "
    "집니다. "
