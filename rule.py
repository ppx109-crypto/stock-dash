...
52회차에 **문을 하나 더 냈습니다.** 네 이동평균선이 정배열인데 그날 거래량이
...
CAVEAT = (
    "**이 수치는 임시입니다.** 조사 대상이 507종목이고 그날 순위를 매길 수 "
    "있는 자료가 2015년 6월부터라, 앞쪽 구간의 매매가 180번입니다. "
    "한 해 서른 번입니다. 27회차에 종목을 3분의 1 덜어 내 보았더니 뒤쪽 "
    ...
    "507종목에서 여덟 번 돌린 가운데값으로 연수익은 앞쪽(2015~2020) "
    "+13.56%(폭 3.7)·뒤쪽(2021~) +37.71%(폭 4.1)이고, **골은 −24.1%와 "
    "−23.1%입니다.** 52회차에 터짐 문을 붙이며 수익이 두 배가 되었는데 "
    "골도 함께 두 배가 되었습니다(추세 문만 쓰던 때는 −10.4%·−11.4%). "
    "연패는 7과 10입니다 — 자리 셋에 −5%씩 열 번 연달아 지는 구간이 "
    "실제로 있었다는 뜻입니다. "
    "한 번만 돌린 "
    "수치는 여러 번 중 좋은 쪽일 수 있습니다 — 40회차에 그런 수치 하나에 "
    "속아 결론을 냈다가 거뒀습니다. 열 번에 다섯 번은 집니다. "
    "특히 **터짐 문은 중앙값이 마이너스(−0.56%)입니다.** 자주 조금씩 지고 "
    "가끔 크게 이겨서 버는 문이라, 몇 달을 내리 잃는 것처럼 보일 수 "
    "있습니다. 추세 문은 중앙값 +0.95%로 성격이 다릅니다. "
