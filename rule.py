...
**아직 임시입니다.** 424종목까지 채워 41회차에 전부 다시 쟀고, 조용함·
정배열폭·보유 10일은 버텼습니다. 그래도 한쪽 구간의 매매가 아흔 번
남짓이고, 종목은 **오늘의** 시가총액으로 고른 것이라 살아남은 회사만
보는 쪽입니다. 방향은 믿되 자릿수는 믿지 마십시오.
"""
...
WHY = (
    ...
    "40%), 180일 추세선이 닷새 사이 1.46% 올라 있고, 60일 전보다 25% 넘게 "
    "올라 있는 날입니다. "
...
CAVEAT = (
    "**이 수치는 임시입니다.** 조사 대상이 424종목이고 그날 순위를 매길 수 "
    "있는 자료가 2015년 6월부터라, 한쪽 구간의 매매가 아흔 번 남짓입니다. "
    "한 해 스무 번입니다. 27회차에 종목을 3분의 1 덜어 내 보았더니 뒤쪽 "
    "수익이 반토막 났습니다. 그 정도로 흔들리는 표본입니다. "
    "게다가 424종목은 **오늘의** 시가총액으로 고른 것이라, 2016년에 100등 "
    "안이었다가 지금 작아진 회사는 아예 들어 있지 않습니다. 살아남은 것만 "
    "보는 쪽이라 성적이 실제보다 좋게 나옵니다. "
    "여덟 번 돌린 가운데값으로 골은 앞쪽(2015~2020) −13.3%, 뒤쪽(2021~) "
    "−12.5%이고 연수익은 +5.37%와 +13.25%입니다. 한 번만 돌리면 +6.62%와 "
    "+14.54%가 나오는데, 그것은 여러 번 중 좋은 쪽입니다 — 40회차에 그런 "
    "수치 하나에 속아 결론을 냈다가 거뒀습니다. 열 번에 다섯 번은 집니다. "
