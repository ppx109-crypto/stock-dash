...
# 단기·중기·중장기·장기·추세 다섯 축입니다. 같은 이동평균이라도 길이에 따라
# 말하는 것이 다릅니다. 짧은 것은 며칠의 흔들림을, 긴 것은 몇 달의 흐름을
# 봅니다. 여럿을 함께 두면 '무엇이 어긋났는지'가 읽힙니다.
#
# 35회차에 축 길이 자체를 처음으로 바꿔 보았습니다. 긴 축을 120에서 180·240·
# 300·360으로 늦추니 성적이 한 방향으로 좋아지다가 300에서 꺾였습니다.
# 꼭대기인 180을 '추세축'으로 덧붙입니다. 반대로 정배열폭을 재는 짝(20/60)은
# 늘릴수록 나빠졌으므로 그대로 둡니다.
AXES = {"단기": 5, "중기": 20, "중장기": 60, "장기": 120, "추세": 180}
# 모임폭·정배열일수·교차는 네 선으로 잽니다. 34회차의 수치와 견주려면 재는
# 대상이 그대로여야 합니다. 추세축(180)은 35회차에 덧붙인 다섯째 축입니다.
FAN = (5, 20, 60, 120)
